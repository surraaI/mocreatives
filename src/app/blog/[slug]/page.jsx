...
const BlogPostPage = () => {
  ...
  return (
    <div className="text-white bg-black min-h-screen overflow-x-hidden box-border">
      ...
      <section className="bg-black min-h-[40vh] flex items-center justify-center px-4 py-12">
        <div className="text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-cultural-red mb-4">
            {post.title}
          </h1>
